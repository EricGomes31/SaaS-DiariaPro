...
export default function SearchableSelect({
  ...
  const selectedLabel = options.find(o => o.value === value)?.label ?? (allowCustom && value ? value : '')
  ...
  const [paddingTop, paddingRight = paddingTop, paddingBottom = paddingTop] = padding.split(' ')
