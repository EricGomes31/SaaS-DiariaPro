...
import { Zap, Eye, EyeOff, ArrowRight, User, Mail, Sun, Moon, CheckCircle } from 'lucide-react'
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        <div className="orb" style={{ position: 'absolute', width: 600, height: 600, background: 'radial-gradient(circle, rgba(99,102,241,0.12) 0%, transparent 65%)', top: -200, left: -150, animationDelay: '0s' }} />
        <div className="orb" style={{ position: 'absolute', width: 450, height: 450, background: 'radial-gradient(circle, rgba(139,92,246,0.1) 0%, transparent 65%)', bottom: -120, right: -80, animationDelay: '4s' }} />
        <div className="orb" style={{ position: 'absolute', width: 300, height: 300, background: 'radial-gradient(circle, rgba(16,185,129,0.07) 0%, transparent 70%)', top: '50%', left: '40%', animationDelay: '7s' }} />
      </div>
      ...
      {!isMobile && (
        <motion.div
          ...
          style={{
            ...
            padding: '48px 56px', borderRight: c.panelBorder,
          }}
        >
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }}
            style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 20px rgba(99,102,241,0.45)' }}>
              <Zap size={20} color="white" fill="white" />
            </div>
            <div>
              <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 20, color: c.text, letterSpacing: '-0.02em' }}>Diária Pro</div>
              <div style={{ fontSize: 10, color: c.logoSub, fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase' }}>Gestão de Diaristas</div>
            </div>
          </motion.div>

          <div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.6 }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '5px 14px', borderRadius: 100, marginBottom: 28, background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.2)', fontSize: 12, fontWeight: 600, color: '#818cf8', letterSpacing: '0.05em' }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#10b981', display: 'inline-block' }} />
                {isInvite ? 'Bem-vindo à equipe!' : 'Grátis para começar'}
              </div>
              <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(2.2rem, 3.2vw, 3rem)', fontWeight: 800, color: c.text, margin: '0 0 20px', letterSpacing: '-0.03em', lineHeight: 1.1 }}>
              ...
              <p style={{ fontSize: 16, color: c.subMid, lineHeight: 1.65, margin: 0, maxWidth: 360 }}>
                {isInvite
                  ? 'Defina seu nome e crie uma senha segura para acessar o painel completo.'
                  : 'Cadastre-se e tenha controle total de jornadas, pagamentos e relatórios em um só lugar.'}
              </p>
            </motion.div>

            <div style={{ marginTop: 44 }}>
              {[
                { emoji: '✅', text: 'Cadastro gratuito, sem cartão de crédito' },
                { emoji: '⚡', text: 'Pronto para usar em menos de 2 minutos' },
                { emoji: '🔒', text: 'Seus dados seguros com criptografia total' },
              ].map((item, i) => (
                <motion.div key={i}
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <div style={{ position: 'absolute', top: 0, left: '20%', right: '20%', height: 1, background: c.accentLine }} />

            {/* Mobile logo */}
            {isMobile && (
              <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.4 }}
                style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 28 }}>
                <div style={{ width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 16px rgba(99,102,241,0.4)', flexShrink: 0 }}>
                  <Zap size={16} color="white" fill="white" />
                </div>
                <div>
                  <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 17, color: c.text, letterSpacing: '-0.02em' }}>Diária Pro</div>
                  <div style={{ fontSize: 9, color: c.logoSub, fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase' }}>Gestão de Diaristas</div>
                </div>
              </motion.div>
            )}
              ...
              {done ? (
                ...
                >
                  <motion.div
                    ...
                    style={{ width: 64, height: 64, borderRadius: 18, background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}
                  >
                    <CheckCircle size={30} color="#34d399" />
                  </motion.div>
                  <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 22, fontWeight: 800, color: c.text, margin: '0 0 10px' }}>
                    Conta criada!
                  </h2>
                  <p style={{ fontSize: 14, color: c.subMid, lineHeight: 1.65, margin: '0 0 8px' }}>
                    Enviamos um link de confirmação para
                  </p>
                  <p style={{ fontSize: 15, fontWeight: 700, color: '#818cf8', margin: '0 0 24px', wordBreak: 'break-all' }}>
                    {email}
                  </p>
                  ...
                  <motion.button onClick={onLogin}
                    ...
                    style={{ width: '100%', padding: '14px', borderRadius: 13, fontSize: 14, fontWeight: 700, border: 'none', cursor: 'pointer', background: 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', color: 'white', fontFamily: 'Inter, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, boxShadow: '0 6px 20px rgba(99,102,241,0.35)' }}
                  >
                ...
                <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.45 }}
                    style={{ marginBottom: isMobile ? 22 : 30 }}>
                    <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: isMobile ? 22 : 26, fontWeight: 800, color: c.text, margin: '0 0 8px', letterSpacing: '-0.025em' }}>
                      {isInvite ? 'Crie sua senha' : 'Criar conta'}
                    </h2>
                    <p style={{ margin: 0, fontSize: 14, color: c.subMid }}>
                      {isInvite
                        ? (currentUser?.email ? `Bem-vindo! Configure o acesso para ${currentUser.email}` : 'Defina seu nome e uma senha para acessar o painel')
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.38, duration: 0.4 }} style={{ marginBottom: 14 }}>
                      <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: c.sub, marginBottom: 8, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Nome completo</label>
                    ...
                    {isInvite ? (
                      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.42, duration: 0.4 }} style={{ marginBottom: 14 }}>
                        <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: c.sub, marginBottom: 8, letterSpacing: '0.06em', textTransform: 'uppercase' }}>E-mail</label>
                        <div style={{ position: 'relative' }}>
                          <Mail size={15} color={c.muted} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
                          <div style={{ ...inputStyle(''), paddingLeft: 38, opacity: 0.6, cursor: 'default' }}>
                            {currentUser?.email ?? '—'}
                          </div>
                        </div>
                      </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.46, duration: 0.4 }} style={{ marginBottom: 14 }}>
                      <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: c.sub, marginBottom: 8, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Senha</label>
                      <div style={{ position: 'relative' }}>
                        ...
                        <button type="button" onClick={() => setShowPwd(p => !p)}
                          style={{ position: 'absolute', right: 14, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: c.muted, display: 'flex', alignItems: 'center', padding: 0, transition: 'color 0.2s' }}
                    ...
                    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.4 }} style={{ marginBottom: 10 }}>
                      <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: c.sub, marginBottom: 8, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Confirmar senha</label>
                    ...
                    <AnimatePresence>
                      {error && (
                        <motion.div
                          ...
                          style={{ padding: '10px 14px', borderRadius: 10, marginBottom: 14, background: 'rgba(244,63,94,0.08)', border: '1px solid rgba(244,63,94,0.2)', fontSize: 13, color: '#fb7185', fontWeight: 500, lineHeight: 1.4, overflow: 'hidden' }}
                        >
                          {error}
                        </motion.div>
                      )}
                    ...
                    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.54, duration: 0.4 }} style={{ marginTop: 20 }}>
                      <motion.button type="submit" disabled={isLoading}
                        ...
                        style={{ width: '100%', padding: '15px', borderRadius: 13, fontSize: 15, fontWeight: 700, border: 'none', cursor: isLoading ? 'not-allowed' : 'pointer', background: isLoading ? 'rgba(99,102,241,0.4)' : 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, boxShadow: isLoading ? 'none' : '0 6px 20px rgba(99,102,241,0.35)', transition: 'background 0.3s', fontFamily: 'Inter, sans-serif' }}>
                        <AnimatePresence mode="wait">
                          {isLoading ? (
                  ...
                  {!isInvite && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6, duration: 0.4 }}
                      style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: c.muted }}>
                      Já tem uma conta?{' '}
                      <button onClick={onLogin} style={{ background: 'none', border: 'none', fontSize: 14, fontWeight: 700, color: '#818cf8', cursor: 'pointer', fontFamily: 'Inter, sans-serif', padding: 0 }}>
                        Fazer login
                      </button>
                    </motion.div>
                  )}
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.75, duration: 0.4 }}
            style={{ textAlign: 'center', marginTop: 24, fontSize: 12, color: c.dim, lineHeight: 1.5 }}>
            © 2025 Diária Pro. Todos os direitos reservados.
          </motion.p>
        </motion.div>
      </div>
