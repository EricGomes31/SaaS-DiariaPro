...
import { ArrowRight, BarChart3, Eye, EyeOff, Lock, Shield, User, Users, Zap } from 'lucide-react'
        ...
        <motion.div initial={{ opacity: 0, y: 24, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.2, duration: 0.6, ease: [0.4, 0, 0.2, 1] }} style={{ width: '100%', maxWidth: 420 }}>
          ...
          <div
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Confirmar senha */}
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.52, duration: 0.4 }} style={{ marginBottom: 10 }}>
                <label
                  style={{
                    display: 'block',
                    fontSize: 12,
              ...
              {/* Submit */}
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.58, duration: 0.4 }} style={{ marginTop: 22 }}>
                <motion.button
                  type="submit"
                  disabled={loading}
                  whileHover={
