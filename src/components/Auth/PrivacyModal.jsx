...
import { Cookie, FileText, Shield, X } from 'lucide-react'
      ...
      <Section title="2. Dados que coletamos">
        <ul style={{ paddingLeft: 18, margin: 0 }}>
          <li style={{ marginBottom: 6 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Dados da conta:</strong> nome e e-mail do usuário administrador, necessários para autenticação.
          </li>
          <li style={{ marginBottom: 6 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Dados dos diaristas:</strong> nome, foto (opcional), dias trabalhados, valores de pagamento e locais de trabalho — inseridos pelo próprio usuário.
          </li>
          <li style={{ marginBottom: 6 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Dados de uso:</strong> log de ações no sistema (login, cadastros, pagamentos) para fins de auditoria interna.
          </li>
          <li>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Dados técnicos:</strong> preferências de tema e idioma, armazenados localmente no navegador.
          </li>
        </ul>
      </Section>
      ...
      <Section title="4. Base legal (LGPD)">
        ...
        <ul style={{ paddingLeft: 18, margin: '8px 0 0' }}>
          <li style={{ marginBottom: 4 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Execução de contrato</strong> — Art. 7º, V: necessário para prestação do serviço contratado.
          </li>
          <li>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Legítimo interesse</strong> — Art. 7º, IX: logs de auditoria e segurança da plataforma.
          </li>
        </ul>
      </Section>

      <Section title="5. Armazenamento e segurança">
        Os dados são armazenados na plataforma <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Supabase</strong> (PostgreSQL na nuvem), com criptografia em repouso e em trânsito (TLS 1.2+). O acesso é protegido por autenticação e políticas de Row-Level Security (RLS), garantindo que cada usuário acesse apenas seus
        próprios dados.
      </Section>

      <Section title="6. Compartilhamento de dados">Não compartilhamos dados com terceiros para fins comerciais. Os dados trafegam exclusivamente entre o navegador do usuário e os servidores do Supabase. Não utilizamos serviços de analytics ou publicidade.</Section>

      <Section title="7. Retenção">Os dados são mantidos enquanto a conta estiver ativa. Após o encerramento, os dados podem ser excluídos mediante solicitação.</Section>
  ...
  return (
    <>
      ...
      <Section title="1. Definições">
        <ul style={{ paddingLeft: 18, margin: 0 }}>
          <li style={{ marginBottom: 4 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Plataforma:</strong> o sistema web Diária Pro, acessado via navegador.
          </li>
          <li style={{ marginBottom: 4 }}>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Usuário:</strong> pessoa física ou jurídica que acessa a plataforma mediante convite.
          </li>
          <li>
            <strong style={{ color: 'rgba(255,255,255,0.8)' }}>Diarista:</strong> trabalhador cujos dados são gerenciados pelo Usuário dentro da plataforma.
          </li>
        </ul>
      </Section>

      <Section title="2. Acesso e conta">O acesso é concedido por convite do administrador. Você é responsável por manter sua senha em sigilo e por todas as ações realizadas com sua conta. Em caso de uso não autorizado, notifique imediatamente o administrador do sistema.</Section>
      ...
      <Section title="6. Disponibilidade">Buscamos manter a plataforma disponível 24/7, mas não garantimos uptime ininterrupto. Manutenções programadas serão comunicadas com antecedência quando possível. Não somos responsáveis por perdas decorrentes de indisponibilidade temporária.</Section>

      <Section title="7. Limitação de responsabilidade">O Diária Pro não se responsabiliza por danos indiretos, lucros cessantes ou perda de dados causados por uso inadequado da plataforma, falhas de conexão do usuário ou eventos fora do nosso controle.</Section>

      <Section title="8. Alterações nos termos">Podemos atualizar estes termos a qualquer momento. A versão vigente estará sempre disponível na tela de login. O uso continuado da plataforma após alterações implica aceitação dos novos termos.</Section>

      <Section title="9. Foro">Fica eleito o foro da comarca de domicílio do Usuário para dirimir quaisquer controvérsias decorrentes destes termos, com renúncia a qualquer outro, por mais privilegiado que seja.</Section>
    </>
  )
}
...
function CookiesContent() {
  return (
    <>
      ...
      <Section title="3. Como gerenciar">Você pode limpar os dados do localStorage a qualquer momento pelas ferramentas do desenvolvedor do seu navegador (F12 → Application → Local Storage). Isso irá deslogar você do sistema.</Section>
    </>
  )
}
