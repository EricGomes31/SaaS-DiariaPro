...
import { Bell, CalendarDays, ExternalLink, Globe, Info, Moon, Plus, RotateCcw, Shield, Sun, Trash2, User, X, Zap } from 'lucide-react'
...
const UI = {
  pt: {
    ...
    dateFormatSub: 'Como as datas serão exibidas',
    appearance: 'Aparência',
    appearanceSub: 'Tema da interface',
    dark: 'Escuro',
    light: 'Claro',
    save: 'Salvar alterações',
    notifChannels: 'Canais de notificação',
    notifTypes: 'Tipos de evento',
    emailNotif: 'E-mail',
    emailSub: 'Receber alertas por e-mail',
    pushNotif: 'Push no navegador',
    pushSub: 'Notificações no desktop',
    payments: 'Pagamentos',
    paymentsSub: 'Pagamentos pendentes e realizados',
    newWorkers: 'Novos diaristas',
    newWorkersSub: 'Quando um novo trabalhador for cadastrado',
    reports: 'Relatórios prontos',
    reportsSub: 'Quando um relatório estiver disponível',
    auth: 'Autenticação',
    ...
    session: 'Sessão',
    sessionInfo: 'Iniciada há 32 minutos · Chrome · Windows 11',
    active: 'Ativa',
    twoFA: 'Autenticação em dois fatores',
    twoFASub: 'Adicione uma camada extra de segurança',
    system: 'Sistema',
    support: 'Suporte',
    docs: 'Documentação',
  ...
  en: {
    ...
    dateFormatSub: 'How dates will be displayed',
    appearance: 'Appearance',
    appearanceSub: 'Interface theme',
    dark: 'Dark',
    light: 'Light',
    save: 'Save changes',
    ...
    emailNotif: 'Email',
    emailSub: 'Receive alerts by email',
    pushNotif: 'Browser push',
    pushSub: 'Desktop notifications',
    payments: 'Payments',
    paymentsSub: 'Pending and completed payments',
    newWorkers: 'New workers',
    newWorkersSub: 'When a new worker is registered',
    reports: 'Ready reports',
    reportsSub: 'When a report is available',
    auth: 'Authentication',
    ...
    session: 'Session',
    sessionInfo: 'Started 32 minutes ago · Chrome · Windows 11',
    active: 'Active',
    twoFA: 'Two-factor authentication',
    twoFASub: 'Add an extra layer of security',
    system: 'System',
    support: 'Support',
    docs: 'Documentation',
    ticket: 'Open ticket',
  ...
  es: {
    ...
    dateFormatSub: 'Cómo se mostrarán las fechas',
    appearance: 'Apariencia',
    appearanceSub: 'Tema de la interfaz',
    dark: 'Oscuro',
    light: 'Claro',
    save: 'Guardar cambios',
    notifChannels: 'Canales de notificación',
    notifTypes: 'Tipos de evento',
    emailNotif: 'Correo electrónico',
    emailSub: 'Recibir alertas por correo',
    pushNotif: 'Push en navegador',
    pushSub: 'Notificaciones de escritorio',
    payments: 'Pagos',
    paymentsSub: 'Pagos pendientes y realizados',
    newWorkers: 'Nuevos trabajadores',
    newWorkersSub: 'Cuando se registre un nuevo trabajador',
    reports: 'Informes listos',
    reportsSub: 'Cuando un informe esté disponible',
    auth: 'Autenticación',
    ...
    session: 'Sesión',
    sessionInfo: 'Iniciada hace 32 minutos · Chrome · Windows 11',
    active: 'Activa',
    twoFA: 'Autenticación de dos factores',
    twoFASub: 'Añade una capa extra de seguridad',
    system: 'Sistema',
    support: 'Soporte',
    docs: 'Documentación',
    ticket: 'Abrir ticket',
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        border: 'none',
        cursor: 'pointer',
        background: checked ? 'linear-gradient(135deg, #6366f1, #8b5cf6)' : (offBg ?? 'rgba(255,255,255,0.1)'),
        position: 'relative',
        flexShrink: 0,
  ...
  return (
    <div
      style={{
        ...
        alignItems: 'center',
        padding: '14px 0',
        borderBottom: `1px solid ${rowBorder ?? 'rgba(255,255,255,0.04)'}`,
      }}>
      <div>
        <div
          style={{
        ...
        {sub && (
          <div
            style={{
              fontSize: 12,
              color: rowSub ?? 'rgba(255,255,255,0.3)',
              marginTop: 2,
            }}>
            {sub}
          </div>
                ...
                <motion.button
                  ...
                  <span
                    style={{
                      ...
                      color: active ? sp.tabActiveText : sp.tabText,
                      whiteSpace: 'nowrap',
                    }}>
                    {tabItem.label}
                  </span>
              ...
              <motion.div key={tab} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} transition={{ duration: 0.2 }}>
                ...
                {tab === 'notifs' && (
                  <div>
                    ...
                    <SectionTitle color={sp.sectionTitle} style={{ marginTop: 24 }}>
                      {t.notifTypes}
                    </SectionTitle>
                      ...
                      {pwdMsg.text && (
                        <div
                          style={{
                            fontSize: 12,
                            marginBottom: 8,
                            color: pwdMsg.error ? '#f43f5e' : '#10b981',
                            fontWeight: 500,
                          }}>
                          {pwdMsg.text}
                        </div>
                    ...
                    <div style={{ marginBottom: 20 }}>
                      <div
                        style={{
                          fontSize: 14,
                          fontWeight: 600,
                          color: sp.holidayTitleColor,
                          marginBottom: 4,
                        }}>
                        {t.holidaysRegistered}
                      </div>
                    ...
                    <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          if (!isValid(parseISO(newHolidayDate))) {
                            setHolidayError(t.invalidDate)
                            return
                          }
                          if (holidays.includes(newHolidayDate)) {
                            setHolidayError(t.duplicateDate)
                            return
                          }
                      ...
                      {holidays.length === 0 ? (
                        ...
                        holidays.map(dateStr => {
                          ...
                          const label = isValid(parsed)
                            ? format(parsed, "dd 'de' MMMM 'de' yyyy", {
                                locale: ptBR,
                              })
                            : dateStr
                  ...
                  <div>
                    ...
                    <div
                      style={{
                        ...
                        border: `1px solid ${sp.aboutCardBorder}`,
                        display: 'flex',
                        alignItems: 'center',
                        gap: 16,
                      }}>
                      ...
                      <Row key={i} label={r.label} rowBorder={sp.rowBorder} rowLabel={sp.rowLabel} rowSub={sp.rowSub}>
                        <motion.button
                          ...
                          style={{
                            ...
                            padding: '6px 12px',
                            borderRadius: 8,
                            border: `1px solid ${sp.supportBorder}`,
                            background: sp.supportBg,
                            color: '#818cf8',
                            cursor: 'pointer',
                            fontSize: 12,
                            fontWeight: 600,
