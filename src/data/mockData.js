...
export const JOB_TITLES = ['Salon Line', 'CCB', 'Doca', 'Shopee', 'Macrolub', 'Arteb', 'BR BRAND', 'Beneficiamento', 'Auxiliar', 'Limpeza', 'Puxada', 'Leroy', 'Etiquetagem', 'Rheem', 'Jorge Bischoff', 'Leonfer', 'Extra beneficiamento', 'Diarista']
